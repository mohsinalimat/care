(function () {
	...
	class CellManager {
	    ...
	    bindCopyCellContents() {
	        ...
	        this.keyboard.on('ctrl+c', function () {
	            ...
	            var message = this$1.instance.translate('{count} cells copied', {
	...
	class ColumnManager {
	    ...
	    bindResizeColumn() {
	        ...
	        var onMouseMove = function (e) {
	            ...
	            if (this$1.options.direction === 'rtl') {
	                delta = -1 * delta;
	            }
	            var finalWidth = startWidth + delta;
	            var ref = $.data($resizingCell);
	            var colIndex = ref.colIndex;
	...
	class RowManager {
	    ...
	    showCheckStatus() {
	        ...
	        if (count > 0) {
	            var message = this.instance.translate('{count} rows selected', {
	                count: count
	            });
	...
	class TranslationManager {
	    ...
	    translate(sourceText, args) {
	        var translation = (this.translations[this.language] &&
	...
	class DataTable {
	    ...
	    buildOptions(options) {
	        ...
	        this.options.headerDropdown = this.DEFAULT_OPTIONS.headerDropdown.concat( options.headerDropdown
	        );
